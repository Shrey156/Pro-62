    ...
    return (
      ...
      <View style={{ flex: 1,backgroundColor:"grey" }}>
        ...
        <View
          ...
          <Text style={{color:"orange",fontSize:20,}}>Present: {this.state.present_students.length}</Text>
          <Text style={{color:"orange",fontSize:20,}}>Absent: {this.state.absent_students.length}</Text>
        </View>
